...
class FreeplayState extends MusicBeatState
{
	...
	var RUSHNOTE:FlxSprite = new FlxSprite();
	var tmr:FlxTimer;
	...
	default:
		...
		chars = new FlxSprite().loadGraphic('assets/images/MenuUI/Freeplay/NA.png');
		...
		diffsprite = new FlxSprite().loadGraphic('assets/images/MenuUI/Freeplay/diff/normal.png');
		diffsprite.antialiasing = true;
		
		arrowr = new FlxSprite().loadGraphic('assets/images/MenuUI/smallarrow.png');
		arrowr.antialiasing = true;
		
		arrowl = new FlxSprite().loadGraphic('assets/images/MenuUI/smallarrow.png');
		arrowl.antialiasing = true;
		arrowl.flipX = true;
		
		RUSHNOTE = new FlxSprite().loadGraphic('assets/images/MenuUI/Freeplay/Rush.png');
		RUSHNOTE.antialiasing = true;
		...
		diffText.font = "assets/fonts/funkin.otf";
		diffText.x += 120;
		diffText.alpha = 0;
		add(diffText);
		if (soundTest || !OptionsHandler.options.style)
		...
		diffsprite.x = diffText.x;
		diffsprite.y = diffText.y;
	...
	function checkpos()
	{
		...
		{
			case "EASY":
				diffsprite.x = 913.6 + 65;
				
			case "NORMAL":
				diffsprite.x = 913.6 + 10;
				
			case "HARD":
				diffsprite.x = 913.6 + 55;
	...
	function changeDiff(change:Int = 0)
	{
		...
		diffsprite.loadGraphic(Paths.image('MenuUI/Freeplay/diff/' + diffText.text));
		checkpos();
	}
	...
	function checkchar()
	{
		chars.y = 110.5;
		chars.alpha = 0.8;
		FlxTween.tween(chars, {y: 126.5, alpha: 1}, 0.04, {ease: FlxEase.quartIn});
		switch curSelected
		{
	    case 0:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/smiler'));
			
		case 1:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/stitchface'));
			
		case 2:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/smilermad'));
			
		case 3 , 4 , 5:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/roleplayer'));
			
		case 6 , 7:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/soldier'));
			
		case 8 , 9:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/tryhard'));
			
		case 10 , 11:
			chars.loadGraphic(Paths.image('MenuUI/Freeplay/rager'));
		}
	}
}
