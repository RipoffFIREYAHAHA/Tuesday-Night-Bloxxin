...
class DialogueBox extends FlxSpriteGroup
{
	...
	{	
		...
		dropText = new FlxText(242, 482, Std.int(FlxG.width * 0.6), "", 30);
		dropText.font = "assets/fonts/funkin.otf";
		dropText.color = shadowColor;
		add(dropText);

		swagDialogue = new FlxTypeText(240, 480, Std.int(FlxG.width * 0.6), "", 30);
	...
	function startDialogue():Void
	{
		...
		dropText.font = swagDialogue.font = "assets/fonts/funkin.otf";
		dropText.size = swagDialogue.size = 30;
